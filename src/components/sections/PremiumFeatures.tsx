      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col">
          <div className="relative aspect-[4/3] mb-6 overflow-hidden rounded-xl border border-[#E5E7EB] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)]">
            <Image
              src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/light-personalized-reccs-14.jpg"
        ...
        <div className="flex flex-col">
          <div className="relative aspect-[4/3] mb-6 overflow-hidden rounded-xl border border-[#E5E7EB] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)]">
            <Image
              src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/light-smart-suggestions-15.jpg"
