      ...
      <div className="container px-5 md:px-10 mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-20">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="pb-10">
              <div className="flex items-center gap-3 mb-4">
                <Image 
                  src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/light-sparkles-icon-7.svg" 
                  alt="Sparkles icon" 
                  width={32} 
                  height={32}
                  className="w-8 h-8"
            ...
            <div className="divide-y border-t border-b mb-10 lg:mb-24">
              <div className="flex items-center gap-4 py-5 group cursor-default">
                <div className="w-8 h-8 flex items-center justify-center rounded-md bg-[#f9fafb]">
                  <Image 
                    src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/light-flame-icon-9.svg" 
                    alt="Flame icon" 
                    width={16} 
                    height={16}
                  />
              ...
              <div className="flex items-center gap-4 py-5 group cursor-default">
                <div className="w-8 h-8 flex items-center justify-center rounded-md bg-[#f9fafb]">
                  <Image 
                    src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/light-search-icon-11.svg" 
                    alt="Search icon" 
                    width={16} 
                    height={16}
                  />
              ...
              <div className="flex items-center gap-4 py-5 group cursor-default">
                <div className="w-8 h-8 flex items-center justify-center rounded-md bg-[#f9fafb]">
                  <Image 
                    src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/light-filters-icon-13.svg" 
                    alt="Filters icon" 
                    width={16} 
                    height={16}
                  />
          ...
          <div className="lg:col-span-2 relative overflow-hidden rounded-2xl border border-[#e5e7eb] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)]">
            <Image 
              src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/light-discovery-section-12.jpg" 
