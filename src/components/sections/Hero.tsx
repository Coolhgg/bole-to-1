  ...
  return (
    <section className="relative min-h-[900px] overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/light-hero-bg-1.jpg"
      ...
      <div className="container relative z-10 pt-32 pb-12 mx-auto px-5 text-center">
        ...
        >
          <h1 className="inline-flex flex-wrap items-center justify-center gap-x-4 text-[44px] md:text-[72px] font-[900] leading-[1.05] tracking-[-0.04em] text-foreground mb-6">
            ...
            <div className="relative inline-flex align-middle h-[50px] md:h-[80px] w-[40px] md:w-[60px] mx-1">
              ...
              >
                <Image
                  src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/icons/landing-page-manga-1.jpg"
                  alt="Manga Card"
                  fill
              ...
              >
                <Image
                  src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/icons/hero-bookmark-2.png"
                  alt="Bookmark icon"
                  width={56}
                  height={56}
                  priority
        ...
        >
          ...
          <div className="relative rounded-[32px] overflow-hidden border border-border shadow-[0_40px_100px_-20px_rgba(0,0,0,0.4)] bg-card transition-all duration-700 ease-out hover:scale-[1.02] hover:shadow-[0_60px_120px_-30px_rgba(0,0,0,0.5)]">
            <Image
              src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/light-hero-dashboard-2.jpg"
