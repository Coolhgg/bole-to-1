      ...
      <div className="container mx-auto max-w-[1280px]">
        <div className="relative h-[480px] w-full overflow-hidden rounded-[2rem] sm:rounded-[3rem]">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/bg-cta-17.png"
