  ...
  return (
    <footer className="relative w-full bg-[#111827] text-white pt-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/bg-footer-18.png"
      ...
      <div className="container relative z-10 mx-auto px-5 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-5 flex flex-col items-start">
            <div className="mb-6">
              <Image
                src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/light-logo-8ogL60VF-1.svg"
                alt="Kenmei logo"
                width={120}
                height={30}
