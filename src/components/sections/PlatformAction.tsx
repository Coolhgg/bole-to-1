    ...
    <section className="mx-5 2xl:mx-0 py-16 lg:py-24">
      <div className="container relative overflow-hidden rounded-[2.5rem] bg-[#111827] text-white min-h-[600px] lg:min-h-[700px]">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/platform-bg-10.png"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20 items-center">
            ...
            <div className="flex flex-col gap-10">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <img
                    src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/bookmark-icon-3.svg"
                    alt="Bookmark"
                    className="w-8 h-8"
                  />
              ...
              <div className="border-t border-white/10 pt-8 space-y-6">
                <div className="flex items-center gap-4 group">
                  <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 group-hover:bg-white/10 transition-colors">
                    <img
                      src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/platform-filter-icon-4.svg"
                      alt="Filter"
                      className="w-5 h-5"
                    />
                  </div>
                ...
                <div className="flex items-center gap-4 group">
                  <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 group-hover:bg-white/10 transition-colors">
                    <img
                      src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/platform-notes-icon-5.svg"
                      alt="Notes"
                      className="w-5 h-5"
                    />
                  </div>
                ...
                <div className="flex items-center gap-4 group">
                  <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 group-hover:bg-white/10 transition-colors">
                    <img
                      src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/svgs/platform-history-icon-6.svg"
                      alt="History"
                      className="w-5 h-5"
                    />
                  </div>
            ...
            <div className="lg:col-span-2 h-full lg:relative">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] bg-[#1F2937]/50 backdrop-blur-sm lg:translate-x-12">
                <img
                  src="https://nkrxhoamqsawixdwehaq.supabase.co/storage/v1/object/public/test-clones/ea8c8153-f703-425a-ac39-2d781d32758e-kenmei-co/assets/images/platform-11.jpg"
