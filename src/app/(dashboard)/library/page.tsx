...
import { Plus, Search, Grid2X2, List as ListIcon, BookOpen, Star, ArrowUpDown, AlertCircle, FileText, Loader2, Wrench } from "lucide-react"
...
interface LibraryEntry {
  ...
  series_id: string
  status: string
  metadata_status: 'pending' | 'enriched' | 'failed'
