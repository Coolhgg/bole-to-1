...
export default async function SeriesDetailPage({
  ...
  const coverUrl = bestCover?.cover_url || series.cover_url
      ...
      if (user) {
        const [libraryRes, userRes, prioritiesRes, seriesPrefRes] = await Promise.all([
          supabase
        ...
        seriesPreference = seriesPrefRes.data?.source_name || libraryEntry?.preferred_source || null
      }
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {chapterCount && chapterCount > 0 && (
                ...
                {series.content_rating && series.content_rating !== 'safe' && (
                  ...
                  {libraryEntry?.metadata_status === 'failed' && (
                  ...
                  {libraryEntry?.metadata_status === 'pending' && (
                    <Badge variant="outline" className="bg-zinc-100 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400 border-zinc-200 dark:border-zinc-700">
        ...
        <div className="lg:col-span-2 space-y-12">
          {libraryEntry && (
            <MetadataRecoveryBanner
              ...
              metadataStatus={libraryEntry.metadata_status}
              needsReview={libraryEntry.needs_review}
              seriesTitle={series.title}
              sourceUrl={libraryEntry.source_url}
            />
          )}
            ...
            <TabsContent value="chapters" className="pt-8 space-y-6">
                <EnhancedChapterList 
                  ...
                  libraryEntry={libraryEntry ? {
                    ...
                    preferred_source: seriesPreference || libraryEntry.preferred_source,
                  } : null}
                    sources={sourcesForChapterList}
