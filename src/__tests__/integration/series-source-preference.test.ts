import { selectBestSource, sortSourcesByPriority } from '../../lib/source-utils'

describe('Series Source Preference Logic', () => {
  const sources = [
    { id: '1', source_name: 'MangaDex', source_id: 'md1', chapter_url: 'url1', discovered_at: '2023-01-01', is_available: true },
    { id: '2', source_name: 'MangaPark', source_id: 'mp1', chapter_url: 'url2', discovered_at: '2023-01-02', is_available: true },
    { id: '3', source_name: 'MangaSee', source_id: 'ms1', chapter_url: 'url3', discovered_at: '2022-12-01', is_available: true },
  ]
