...
async function runTest() {
  ...
  try {
    ...
    await supabase.from('logical_chapters').insert([
      ...
      { series_id: seriesAId, chapter_number: '1', first_seen_at: twoDaysAgo },
      { series_id: seriesAId, chapter_number: '2', first_seen_at: twoDaysAgo },
      { series_id: seriesAId, chapter_number: '3', first_seen_at: twoDaysAgo },
      { series_id: seriesAId, chapter_number: '4', first_seen_at: twoDaysAgo },
      { series_id: seriesAId, chapter_number: '5', first_seen_at: twoDaysAgo },
      // Series B: 0 in last 7 days, 10 in last 30 (but all old)
      { series_id: seriesBId, chapter_number: '1', first_seen_at: thirtyDaysAgo },
      // Series C: 0 in last 7 days, 5 in last 30 (but 14 days ago)
      { series_id: seriesCId, chapter_number: '1', first_seen_at: fourteenDaysAgo }
    ]);
