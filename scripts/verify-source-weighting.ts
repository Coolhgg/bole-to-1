...
import { selectBestSource } from '../src/lib/source-utils';
  ...
  try {
    ...
    await prisma.chapterSource.create({
      data: {
        ...
        chapter_url: 'https://mangadex.org/chapter/md-100',
    ...
    await prisma.chapterSource.create({
      data: {
        ...
        chapter_url: 'https://mangapark.net/chapter/mp-100',
        discovered_at: new Date('2024-01-01T10:05:00Z'),
      }
    });

    const lcCount = await prisma.logicalChapter.count({ where: { series_id: testSeriesId, chapter_number: new Prisma.Decimal(100) } });
    ...
    const mockSources = [
      {
        ...
        source_name: 'MangaPark',
        source_id: 'mp-1',
        chapter_url: 'https://mangapark.net/1',
      ...
      },
      {
        ...
        source_name: 'MangaDex',
        source_id: 'md-1',
        chapter_url: 'https://mangadex.org/1',
